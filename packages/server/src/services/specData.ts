...
export const SPEC_SCREENS: Record<string, SpecScreen> = {
  ...
  '1_01_02': {
    ...
    linked: [
      ...
      { type: 'api', code: 'GET /auth/oauth/:provider', label: 'OAuth вход (302 на провайдера)' },
      ...
      { type: 'comp', code: 'OAuthGrid', label: 'Сетка OAuth-провайдеров 2×2' },
      { type: 'comp', code: 'TopbarMenu', label: 'Меню разделов в шапке' },
